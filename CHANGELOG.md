...
## [Unreleased]
- **Scorched Yard: every shell looks like itself.** Every projectile was the same white dot. Each weapon's shell now has its own core colour and size, a glow in its colour, and a trail in its manner: a missile's exhaust, a nuke's pulsing green glow and falling sparks, a MIRV's and a Leap Frog's comet tail, a Funky Bomb's rainbow, a tracer's thin grey dots and nothing else, a roller's sparks, a riot bomb's pale wisps, a dirt shell's shed clods, napalm's flickering fire and dripping embers, a digger's spinning glints
