...
## [Unreleased]
- **Scorched Yard: the air is plainer to see at half the count.** Each particle is brighter and thicker with a longer tail, the currents are brighter and wider with longer dashes, and the wash is a little stronger, so the wind reads at a glance with half the particles it had
