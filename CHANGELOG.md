...
## [Unreleased]
- The black hole crosses the board: on Markets it opens a fifth of the way in on one side and drifts slowly along the hours to a fifth from the other, the candles' orbits riding along with it; it is on the Block space list too now, hovering seven units over the tallest cube as it crosses, the cubes beneath drawn up into orbit round it and swallowed
