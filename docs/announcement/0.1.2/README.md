...
the address index (resumable build, the reference check, the undo decoder fixes), the smaller
changes and what to know when upgrading from 0.1.0. The full list is `CHANGELOG.md` under 0.1.2.
