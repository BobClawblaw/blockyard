...
cd blockyard
npm test            # optional: 957 unit tests, all built in
...
npm test             # 957 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (957 tests, plus a live smoke run), the monitoring side is solid, and the
