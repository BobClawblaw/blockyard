...
cd blockyard
npm test            # optional: 964 unit tests, all built in
...
npm test             # 964 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (964 tests, plus a live smoke run), the monitoring side is solid, and the
