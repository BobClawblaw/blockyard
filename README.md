...
cd blockyard
npm test            # optional: 1291 unit tests, all built in
...
npm test             # 1291 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (1291 tests, plus a live smoke run), the monitoring side is solid, and the
