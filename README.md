...
cd blockyard
npm test            # optional: 992 unit tests, all built in
...
npm test             # 992 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (992 tests, plus a live smoke run), the monitoring side is solid, and the
