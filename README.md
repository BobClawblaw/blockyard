...
cd blockyard
npm test            # optional: 861 unit tests, all built in
...
npm test             # 861 unit tests (node:test, no dependencies)
...
comprehensive (861 tests, plus a live smoke run), the monitoring side is solid, and the
