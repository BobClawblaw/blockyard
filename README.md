...
cd blockyard
npm test            # optional: 1455 unit tests, all built in
...
npm test             # 1455 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (1455 tests, plus a live smoke run), the monitoring side is solid, and the
