...
cd blockyard
npm test            # optional: 1072 unit tests, all built in
...
npm test             # 1072 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (1072 tests, plus a live smoke run), the monitoring side is solid, and the
