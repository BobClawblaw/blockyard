...
cd blockyard
npm test            # optional: 927 unit tests, all built in
...
npm test             # 927 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (927 tests, plus a live smoke run), the monitoring side is solid, and the
