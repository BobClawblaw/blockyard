...
cd blockyard
npm test            # optional: 1434 unit tests, all built in
...
npm test             # 1434 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (1434 tests, plus a live smoke run), the monitoring side is solid, and the
