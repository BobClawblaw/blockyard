...
cd blockyard
npm test            # optional: 977 unit tests, all built in
...
npm test             # 977 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (977 tests, plus a live smoke run), the monitoring side is solid, and the
