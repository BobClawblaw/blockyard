...
cd blockyard
npm test            # optional: 843 unit tests, all built in
...
npm test             # 843 unit tests (node:test, no dependencies)
...
comprehensive (843 tests, plus a live smoke run) and the monitoring side is solid, but
