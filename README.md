...
cd blockyard
npm test            # optional: 847 unit tests, all built in
...
npm test             # 847 unit tests (node:test, no dependencies)
...
comprehensive (847 tests, plus a live smoke run) and the monitoring side is solid, but
