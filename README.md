...
cd blockyard
npm test            # optional: 838 unit tests, all built in
...
npm test             # 838 unit tests (node:test, no dependencies)
...
comprehensive (838 tests, plus a live smoke run) and the monitoring side is solid, but
