...
cd blockyard
npm test            # optional: 991 unit tests, all built in
...
npm test             # 991 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (991 tests, plus a live smoke run), the monitoring side is solid, and the
