...
cd blockyard
npm test            # optional: 999 unit tests, all built in
...
npm test             # 999 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (999 tests, plus a live smoke run), the monitoring side is solid, and the
