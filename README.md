...
cd blockyard
npm test            # optional: 980 unit tests, all built in
...
npm test             # 980 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (980 tests, plus a live smoke run), the monitoring side is solid, and the
