...
cd blockyard
npm test            # optional: 1194 unit tests, all built in
...
npm test             # 1194 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (1194 tests, plus a live smoke run), the monitoring side is solid, and the
