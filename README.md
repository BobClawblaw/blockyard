...
cd blockyard
npm test            # optional: 848 unit tests, all built in
...
npm test             # 848 unit tests (node:test, no dependencies)
...
comprehensive (848 tests, plus a live smoke run) and the monitoring side is solid, but
