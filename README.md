...
cd blockyard
npm test            # optional: 965 unit tests, all built in
...
npm test             # 965 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (965 tests, plus a live smoke run), the monitoring side is solid, and the
