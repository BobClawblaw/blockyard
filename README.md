...
cd blockyard
npm test            # optional: 921 unit tests, all built in
...
npm test             # 921 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (921 tests, plus a live smoke run), the monitoring side is solid, and the
