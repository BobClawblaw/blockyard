...
cd blockyard
npm test            # optional: 990 unit tests, all built in
...
npm test             # 990 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (990 tests, plus a live smoke run), the monitoring side is solid, and the
