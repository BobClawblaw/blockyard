...
cd blockyard
npm test            # optional: 981 unit tests, all built in
...
npm test             # 981 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (981 tests, plus a live smoke run), the monitoring side is solid, and the
