...
cd blockyard
npm test            # optional: 855 unit tests, all built in
...
npm test             # 855 unit tests (node:test, no dependencies)
...
comprehensive (855 tests, plus a live smoke run), the monitoring side is solid, and the
