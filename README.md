...
cd blockyard
npm test            # optional: 922 unit tests, all built in
...
npm test             # 922 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (922 tests, plus a live smoke run), the monitoring side is solid, and the
