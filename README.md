...
cd blockyard
npm test            # optional: 993 unit tests, all built in
...
npm test             # 993 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (993 tests, plus a live smoke run), the monitoring side is solid, and the
