...
cd blockyard
npm test            # optional: 863 unit tests, all built in
...
npm test             # 863 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (863 tests, plus a live smoke run), the monitoring side is solid, and the
