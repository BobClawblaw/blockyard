...
cd blockyard
npm test            # optional: 972 unit tests, all built in
...
npm test             # 972 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (972 tests, plus a live smoke run), the monitoring side is solid, and the
