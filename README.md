...
cd blockyard
npm test            # optional: 997 unit tests, all built in
...
npm test             # 997 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (997 tests, plus a live smoke run), the monitoring side is solid, and the
