...
cd blockyard
npm test            # optional: 976 unit tests, all built in
...
npm test             # 976 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (976 tests, plus a live smoke run), the monitoring side is solid, and the
