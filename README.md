...
cd blockyard
npm test            # optional: 996 unit tests, all built in
...
npm test             # 996 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (996 tests, plus a live smoke run), the monitoring side is solid, and the
