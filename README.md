...
cd blockyard
npm test            # optional: 827 unit tests, all built in
...
npm test             # 827 unit tests (node:test, no dependencies)
...
comprehensive (827 tests, plus a live smoke run) and the monitoring side is solid, but
