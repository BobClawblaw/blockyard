...
cd blockyard
npm test            # optional: 983 unit tests, all built in
...
npm test             # 983 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (983 tests, plus a live smoke run), the monitoring side is solid, and the
