...
cd blockyard
npm test            # optional: 985 unit tests, all built in
...
npm test             # 985 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (985 tests, plus a live smoke run), the monitoring side is solid, and the
