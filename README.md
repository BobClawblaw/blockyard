...
cd blockyard
npm test            # optional: 978 unit tests, all built in
...
npm test             # 978 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (978 tests, plus a live smoke run), the monitoring side is solid, and the
