...
cd blockyard
npm test            # optional: 825 unit tests, all built in
...
npm test             # 825 unit tests (node:test, no dependencies)
...
comprehensive (825 tests, plus a live smoke run) and the monitoring side is solid, but
