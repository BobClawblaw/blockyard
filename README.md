...
cd blockyard
npm test            # optional: 857 unit tests, all built in
...
npm test             # 857 unit tests (node:test, no dependencies)
...
comprehensive (857 tests, plus a live smoke run), the monitoring side is solid, and the
