...
cd blockyard
npm test            # optional: 826 unit tests, all built in
...
npm test             # 826 unit tests (node:test, no dependencies)
...
comprehensive (826 tests, plus a live smoke run) and the monitoring side is solid, but
