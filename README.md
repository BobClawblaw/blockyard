...
cd blockyard
npm test            # optional: 839 unit tests, all built in
...
npm test             # 839 unit tests (node:test, no dependencies)
...
comprehensive (839 tests, plus a live smoke run) and the monitoring side is solid, but
