...
cd blockyard
npm test            # optional: 856 unit tests, all built in
...
npm test             # 856 unit tests (node:test, no dependencies)
...
comprehensive (856 tests, plus a live smoke run), the monitoring side is solid, and the
