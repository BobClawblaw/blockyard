...
cd blockyard
npm test            # optional: 844 unit tests, all built in
...
npm test             # 844 unit tests (node:test, no dependencies)
...
comprehensive (844 tests, plus a live smoke run) and the monitoring side is solid, but
