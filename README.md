...
cd blockyard
npm test            # optional: 845 unit tests, all built in
...
npm test             # 845 unit tests (node:test, no dependencies)
...
comprehensive (845 tests, plus a live smoke run) and the monitoring side is solid, but
