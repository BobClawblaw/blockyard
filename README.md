...
cd blockyard
npm test            # optional: 864 unit tests, all built in
...
npm test             # 864 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (864 tests, plus a live smoke run), the monitoring side is solid, and the
