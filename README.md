...
cd blockyard
npm test            # optional: 998 unit tests, all built in
...
npm test             # 998 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (998 tests, plus a live smoke run), the monitoring side is solid, and the
