...
cd blockyard
npm test            # optional: 988 unit tests, all built in
...
npm test             # 988 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (988 tests, plus a live smoke run), the monitoring side is solid, and the
