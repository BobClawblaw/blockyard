...
cd blockyard
npm test            # optional: 994 unit tests, all built in
...
npm test             # 994 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (994 tests, plus a live smoke run), the monitoring side is solid, and the
