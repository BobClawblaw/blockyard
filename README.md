...
cd blockyard
npm test            # optional: 982 unit tests, all built in
...
npm test             # 982 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (982 tests, plus a live smoke run), the monitoring side is solid, and the
