...
cd blockyard
npm test            # optional: 837 unit tests, all built in
...
npm test             # 837 unit tests (node:test, no dependencies)
...
comprehensive (837 tests, plus a live smoke run) and the monitoring side is solid, but
