...
cd blockyard
npm test            # optional: 867 unit tests, all built in
...
npm test             # 867 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (867 tests, plus a live smoke run), the monitoring side is solid, and the
