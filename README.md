...
cd blockyard
npm test            # optional: 979 unit tests, all built in
...
npm test             # 979 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (979 tests, plus a live smoke run), the monitoring side is solid, and the
