...
cd blockyard
npm test            # optional: 1276 unit tests, all built in
...
npm test             # 1276 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (1276 tests, plus a live smoke run), the monitoring side is solid, and the
