...
cd blockyard
npm test            # optional: 987 unit tests, all built in
...
npm test             # 987 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (987 tests, plus a live smoke run), the monitoring side is solid, and the
