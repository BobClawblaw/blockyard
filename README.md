...
cd blockyard
npm test            # optional: 975 unit tests, all built in
...
npm test             # 975 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (975 tests, plus a live smoke run), the monitoring side is solid, and the
