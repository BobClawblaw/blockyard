...
cd blockyard
npm test            # optional: 871 unit tests, all built in
...
npm test             # 871 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (871 tests, plus a live smoke run), the monitoring side is solid, and the
