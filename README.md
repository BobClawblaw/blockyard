...
cd blockyard
npm test            # optional: 995 unit tests, all built in
...
npm test             # 995 unit tests (node:test, no dependencies)
...
The test suite is
comprehensive (995 tests, plus a live smoke run), the monitoring side is solid, and the
