...
x-ray, breathe, fireworks as a display), and the fixes of two days' use. 981 tests. Screenshots
...
`npm test` = 981 tests. `bash scripts/smoke.sh` = 109 checks against a real server.
