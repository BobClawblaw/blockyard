...
x-ray, breathe, fireworks as a display), and the fixes of two days' use. 995 tests. Screenshots
...
`npm test` = 995 tests. `bash scripts/smoke.sh` = 109 checks against a real server.
