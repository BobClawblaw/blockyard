...
**Effects.** Thirty-two, with a no-repeat window (12) per board; two lists (`effects` for Block
...
`npm test` = 865 tests. `bash scripts/smoke.sh` = 109 checks against a real server.
